    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/raddiyalar").permitAll()
                        .requestMatchers(HttpMethod.POST, "/raddiyalar").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/raddiyalar/{id}").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/raddiyalar/{id}").permitAll()
