    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/bux/{id}", "/api/files/img", "/manaviyat", "/maqola", "/madrasahq", "/professor", "/izohlar", "/news", "api/files/img/pdf", "/bux", "/obida", "/qadam", "/alloma", "/qabul", "/xalqaro", "/xorij", "/vd", "/audio", "/raddiya", "/talaba", "/ustoz").permitAll()
