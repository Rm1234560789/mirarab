...
import {getProfessor, setDisplayImg, setImg} from '../reducer/newsReducer.js';
import {deleteProff, saveProff, updateProff} from "../reducer/professorReducer.js";

function BoshProfessor() {
    const {register, reset, handleSubmit, setValue} = useForm();
    const dispatch = useDispatch();
    const {professor} = useSelector((state) => state.newsReducer);
    ...
    function mySubmit(data) {
        if (isEdit !== '') {
            ...
            dispatch(updateProff(data));
        } else {
            data.img = imgInp;
            dispatch(saveProff(data));
        }
        reset();
        setIsEdit('');
        setCurrentId(null);
    ...
    return (
        <div className={'wrapper'}>
            <h1 className={"text"}>Professor</h1>
