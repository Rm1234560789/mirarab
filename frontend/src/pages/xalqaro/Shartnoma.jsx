...
import {deleteShartnoma, getShartnoma, saveShartnoma, updateShartnoma} from "../../reducer/shartnomaReducer.js";

function Islom() {
    const {register, reset, handleSubmit, setValue} = useForm();
    const dispatch = useDispatch();
    const {shartnoma} = useSelector((state) => state.shartnomaReducer);
    ...
    function mySubmit(data) {
        if (isEdit !== '') {
            ...
            dispatch(updateShartnoma(data));
        } else {
            data.img = imgInp;
            dispatch(saveShartnoma(data));
        }
        reset();
        setIsEdit('');
        setCurrentId(null);
    ...
    return (
        <div className={'wrapper'}>
            <h1 className={"text"}>Xalqaro Shartnomalar</h1>
