...
import {deleteObida, getObida, saveObida, updateObida} from "../../reducer/obidaReducer.js";
...
function Obida() {
    ...
    function mySubmit(data) {
        if (isEdit !== '') {
            ...
            dispatch(updateObida(data));
        } else {
            data.img = imgInp;
            dispatch(saveObida(data));
        }
        reset();
        setIsEdit('');
        setCurrentId(null);
    ...
    return (
        <div className={'wrapper'}>
            <h1 className={"text"}>Buxoro Obidalar</h1>
