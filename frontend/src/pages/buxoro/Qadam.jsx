...
import {deleteQadam, getQadam, saveQadam, updateQadam} from "../../reducer/qadamReducer.js";
...
function Islom() {
    ...
    function mySubmit(data) {
        if (isEdit !== '') {
            ...
            dispatch(updateQadam(data));
        } else {
            data.img = imgInp;
            dispatch(saveQadam(data));
        }
        reset();
        setIsEdit('');
        setCurrentId(null);
    ...
    return (
        <div className={'wrapper'}>
            <h1 className={"text"}>Muqaddas Qadamlar</h1>
