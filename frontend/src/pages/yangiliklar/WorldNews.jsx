...
import {deleteDunyo, getDunyo, saveDunyo, updateDunyo} from "../../reducer/dunyoYangiliklariReducer.js";
...
function WorldNews() {
    ...
    function mySubmit(data) {
        if (isEdit !== '') {
            ...
            dispatch(updateDunyo(data));
        } else {
            data.img = imgInp;
            dispatch(saveDunyo(data));
        }
        reset();
        setIsEdit('');
        setCurrentId(null);
    ...
    return (
        <div className={'wrapper'}>
            <h1 className={"text"}>Dunyo Yangiliklari</h1>
